...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Join Chamet Agency to recruit hosts, build an international team, and earn weekly payouts. Trusted training, 24/7 support, and a global community." },
